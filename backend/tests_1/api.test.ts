...
describe('API Endpoints', () => {
    ...
    describe('GET /api/v1/satellites', () => {
        ...
        it('should use default pagination values', async () => {
            const response = await request(app).get('/api/v1/satellites');
    ...
    describe('GET /api/v1/satellites/:noradId', () => {
        it('should return 400 for invalid NORAD ID', async () => {
            const response = await request(app).get('/api/v1/satellites/invalid');
        ...
        it('should return 404 for non-existent satellite', async () => {
            const response = await request(app).get('/api/v1/satellites/99999999');
    ...
    describe('GET /api/v1/satellites/categories', () => {
        it('should return list of categories', async () => {
            const response = await request(app).get('/api/v1/satellites/categories');
