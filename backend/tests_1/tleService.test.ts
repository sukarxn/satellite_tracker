import { parseTLEData } from '../src/services/tleService';
...
2 33591  74.0583 327.5790 0031720 328.8633  31.0926 14.35844873788323`;
            ...
            const result = parseTLEData(sampleTLE);
...
1 25544U 98067A   08264.51782528 -.00002182  00000-0 -11606-4 0  2927`;
            ...
            const result = parseTLEData(incompleteTLE);
            expect(result).toHaveLength(0);
        });
...
`;
            ...
            const result = parseTLEData(tleWithEmptyLines);
